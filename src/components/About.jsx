        ...
        <div className="Mission-Vision-content">
          <div>
            ...
            <p>
              ...
              porttitor. Vestibulum tempus nunc eu tincidunt eleifend. Mauris at
              nunc ultricies, egestas augue in, tempus risus curabitur cursus
              sem lectus. Curabitur sed rutrum neque. Nullam facilisis
              pellentesque porttitor. Vestibulum tempus nunc eu tincidunt
              eleifend. Mauris at nunc ultricies, egestas augue in, tempus risus
              curabitur cursus sem lectus.
            </p>
          </div>
          <div>
            <h6>Vision</h6>
            <p>
              ...
              sagittis. Ut porta rutrum ligula, in ferme tum purus pretium vel.
              Praesent sit amet odio non sem rutrum. Nulla sed pellentesque
              lorem. Phasellus vel nisi sed dui varius aliquet sus pendisse et
              elementum.
            </p>
          </div>
        </div>
      ...
      <section className="text-center">
        ...
        <div className="d-flex justify-content-between">
          <div className="Reasons">
            <FontAwesomeIcon
              className="ReasonsIcon"
              icon="fa-solid fa-hand-holding-dollar"
            />
            <p>Lowest Price Guaranteed</p>
          </div>
          <div className="Reasons">
            <FontAwesomeIcon className="ReasonsIcon" icon="fa-solid fa-gift" />
            <p>Free UK Delivery</p>
          </div>
          <div className="Reasons">
            <FontAwesomeIcon className="ReasonsIcon" icon="fa-solid fa-shop" />
            <p>Shop Online & In store</p>
          </div>
          <div className="Reasons">
            <FontAwesomeIcon className="ReasonsIcon" icon="fa-solid fa-gem" />
